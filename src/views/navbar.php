    ...
    <div class="row">
        ...
        <?php if ($logado) : ?>
            <div class="col-4 d-flex align-content-center p-3">
                <a href="?ct=main&mt=index"><img src="<?= IMAGE_PATH . 'logo-gira.gif' ?>" alt="logo PIM_VI" height="46" class="me-3 rounded-3"></a>
                <a href="?ct=main&mt=index" style="text-decoration: none; color:black;">
                    <!-- <h3 class=""><?= APP_NAME ?></h3> -->
                </a>
            </div>
        <?php else : ?>
            <div class="col-4 d-flex align-content-center p-3">
                <a href="?ct=main&mt=home"><img src="<?= IMAGE_PATH . 'logo-1.png' ?>" alt="logo PIM_VI" height="46" class="me-3"></a>
