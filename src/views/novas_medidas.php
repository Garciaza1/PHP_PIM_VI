                        ...
                        <form action="?ct=main&mt=medidas_submit" method="post" >
                            <div class="row">
                                ...
                                <section class="border border-secundary-subtle rounded-3 p-3 my-2 col-12">
                                    ...
                                    <h5 class="card-title pb-1">Já sabe o Basal ou body fat?
                                    ...
                                    <div class="mb-3 d-none">
                                        <P class="text-danger">O caculo de body fat e metabolismo Basal é feito automaticamente se você não for para a outra pagina</P>
                                        <label class="form-label">Caso já saiba:</label>
                                        <p>Atualize todas as suas medidas inclusive o Metabilismo Basal e sua Gordura corporal <a href="?ct=main&mt=novas_medidas_2">Aqui.</a></p>
                                    </div>
